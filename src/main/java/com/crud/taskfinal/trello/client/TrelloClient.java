...
public class TrelloClient {
    ...
    public List<TrelloBoardDto> getTrelloBoards() {
        URI url = UriComponentsBuilder.fromHttpUrl(trelloConfig.getTrelloApiEndpoint() + "/members/volmidora/boards")
                .queryParam("key", trelloConfig.getTrelloAppKey())
                .queryParam("token", trelloConfig.getTrelloToken())
                .queryParam("fields", "name,id")
                .queryParam("lists", "all").build().encode().toUri();
    ...
    public CreatedTrelloCard createNewCard(TrelloTaskDto trelloTaskDto) {
        URI url = UriComponentsBuilder.fromHttpUrl(trelloConfig.getTrelloApiEndpoint() + "/cards")
                .queryParam("key", trelloConfig.getTrelloAppKey())
                .queryParam("token", trelloConfig.getTrelloToken())
                .queryParam("name", trelloTaskDto.getName())
                .queryParam("desc", trelloTaskDto.getDescription())
                .queryParam("pos", trelloTaskDto.getPos())
                .queryParam("idList", trelloTaskDto.getIdList()).build().encode().toUri();
